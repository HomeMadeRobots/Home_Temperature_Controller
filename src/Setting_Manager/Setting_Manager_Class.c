...
void Setting_Mgr__Increase_Setting_Button_Pressed( void )
{
    switch( Setting_Manager.var_attr->Setting_Mode )
    {
        ...
        case LOW_TEMPERATURE_SETTING :
            Setting_Manager.Temperature_Setting->Increase_Low_Temperature();
            break;
        case HIGH_TEMPERATURE_SETTING :
            Setting_Manager.Temperature_Setting->Increase_High_Temperature();
            break;
        default :
            break;
    }
...
void Setting_Mgr__Decrease_Setting_Button_Pressed( void )
{
    switch( Setting_Manager.var_attr->Setting_Mode )
    {
        ...
        case MINUTE_SETTING :
            ...
            break;
        case LOW_TEMPERATURE_SETTING :
            Setting_Manager.Temperature_Setting->Decrease_Low_Temperature();
            break;
        case HIGH_TEMPERATURE_SETTING :
            Setting_Manager.Temperature_Setting->Decrease_High_Temperature();
            break;
        default :
            break;
    }
